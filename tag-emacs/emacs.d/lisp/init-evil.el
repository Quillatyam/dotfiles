...
(defun rbh--config-evil ()
  ...
  (evil-define-key 'normal global-map (kbd "C--")     'rbh-dired-buffer-dir-or-home)
  ...
  (evil-define-key 'normal global-map (kbd "S-SPC")   'rbh-pop-to-org-agenda-default)
  ...
  (evil-define-key 'normal global-map (kbd "C-t")     'rbh-open-eshell)
...
(defun rbh--apply-evil-other-package-configs ()
...
(use-package evil
  ...
  :config
  (add-hook 'evil-mode-hook 'rbh--config-evil)
  (evil-mode 1)
  ...
  (rbh--apply-evil-other-package-configs))
