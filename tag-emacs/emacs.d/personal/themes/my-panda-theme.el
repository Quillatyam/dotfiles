...
(let ((bg "#292A2B")
  ...
  (custom-theme-set-faces
   ...
   ;; company
   `(company-tooltip ((t (:foreground ,fg :background ,bg+ :bold nil))))
   `(company-tooltip-selection ((t (:foreground ,cyan :background ,bg :bold t))))
   `(company-scrollbar-bg ((t (:background ,bg+))))
   `(company-scrollbar-fg ((t (:background ,fg-))))
   `(company-tooltip-common ((t (:foreground ,cyan :background nil))))
   `(company-tooltip-annotation ((t (:foreground ,cyan :background nil))))
   `(company-tooltip-mouse ((t (:background ,bg))))
   `(company-tooltip-common-selection ((t (:foreground ,cyan :background ,nil))))
   `(company-preview ((t (:background ,bg+))))
   `(company-preview-common ((t (:foreground ,fg :background ,bg+))))
...
(provide-theme 'my-panda)
(provide 'my-panda-theme)

;;; my-panda-theme.el ends here
