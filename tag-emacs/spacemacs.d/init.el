...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '( atom-one-dark-theme volatile-highlights beacon )
...
you should place your code here."
  ...
  ;; Set default shell to sh, this fixes issues with the way fish needs escaping.
