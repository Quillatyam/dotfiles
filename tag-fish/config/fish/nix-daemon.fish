...
else if test -e "$NIX_USER_PROFILE_DIR/etc/ssl/certs/ca-bundle.crt" ; # fall back to cacert in the user's Nix profile
    set -xg NIX_SSL_CERT_FILE $NIX_USER_PROFILE_DIR/etc/ssl/certs/ca-bundle.crt
else if test -e "/nix/var/nix/profiles/default/etc/ssl/certs/ca-bundle.crt" ; # fall back to cacert in the default Nix profile
    set -xg NIX_SSL_CERT_FILE /nix/var/nix/profiles/default/etc/ssl/certs/ca-bundle.crt
end

set -xg NIX_PATH /nix/var/nix/profiles/per-user/root/channels
set -xg PATH $HOME/.nix-profile/bin $HOME/.nix-profile/lib/kde4/libexec /nix/var/nix/profiles/default/bin /nix/var/nix/profiles/default /nix/var/nix/profiles/default/lib/kde4/libexec $PATH
