#!/usr/bin/env fish
# --8<-- [This file is automatically generated from /Users/robert/.nix-profile/etc/profile.d/nix.sh, do not edit] ---
if test -n "$HOME" ; and test -n "$USER" ;
    for d in $PATH; if test -e $d; set __savedpath $d $__savedpath; end; end;
    set -xg PATH /nix/store/hp0x0xvs98nl7fq15sqgamvm254a050w-coreutils-8.29/bin
